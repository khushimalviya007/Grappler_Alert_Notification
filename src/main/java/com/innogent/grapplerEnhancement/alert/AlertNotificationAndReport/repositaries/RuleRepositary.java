...
public interface RuleRepositary extends JpaRepository <Rule,Long> {
    public Rule findBySourcesAndScopeAndIdentityAndTriggerAndConditionAndIsDeletedAndIsEnabled(Sources sources, String scope, String identity, String trigger, String condition,boolean isDeleted,boolean isEnabled);
